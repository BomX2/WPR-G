...
const AanvraagBackOffice = () => {
        ...
        const fetchAanvragen = async () => {
            try {
                ...
                const geupdateData = data.map((item) => ({
                    ...item,
                    id: item.id,
                    persoonsGegevens: item.persoonsGegevens,
    ...
    return (
        <div>
            <h1>Onbehandelde huur aanvragen:</h1>
                        ...
                        {modalWindow &&  (
                            <div className="modal-overlay">
                                <div className="modal-content">
                                    ...
                                    <p>wil toyota huren in de periode van: {activeItem.startDatum} tot {activeItem.eindDatum}  </p>
